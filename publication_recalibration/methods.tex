...
The weight parameters ($w_m = 0.4$, $w_c = 0.3$, $w_d = 0.3$) were selected through grid search optimization targeting minimum Jensen-Shannon divergence from literature distributions while maximizing high-risk pair sensitivity. Sensitivity analysis (Supplementary Figure S1) demonstrates robustness across weight perturbations of $\pm$0.1.
